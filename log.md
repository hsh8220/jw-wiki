...
## [2026-06-11] query  | 예레미야 6:16 주제성구 연설 요약
- 예레미야 4~6장 범위에서 주제성구로 명시된 연설은 존 에크란 "참종교는 그리스도의 제자들을 연합시킵니다"(예레미야 6:16) 1건.
- 해당 소스 페이지에 한 줄 요약 + 핵심 내용(도입 일화·반론 3가지·정글 탐험가 비유·결론) + 주요 성구 섹션을 전사본 정독으로 손수 보강.
